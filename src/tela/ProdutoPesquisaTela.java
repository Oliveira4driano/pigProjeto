...
import modelo.ProdutoTabelaModelo;
...
public class ProdutoPesquisaTela extends javax.swing.JFrame {
    ...
    private Produto produto=new Produto();//Filtro
    private Produto produtoSelecionado;//Criada para não mexer no filtro para não sumir o filtro que estava na tela
    private List<Produto> produtos = new ArrayList<Produto>(); //tabela
    ...
    public void cadastrar(){
        ProdutoCadastraTela tela= new ProdutoCadastraTela();
    ...
    private void preencherTabela(){
        tabela.setModel(new ProdutoTabelaModelo(produtos));
    }
    
    private void selecionarProduto(){
        this.produtoSelecionado=produtos.get(tabela.getSelectedRow());
        
    }
    
    private void abrirTelaConsulta(){
        ProdutoConsultaTela tela =new ProdutoConsultaTela(produtoSelecionado);
        tela.setVisible(true);
    }
