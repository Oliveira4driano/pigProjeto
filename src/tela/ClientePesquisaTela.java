...
import modelo.ClienteTabelaModelo;
...
public class ClientePesquisaTela extends javax.swing.JFrame {
    ...
    private Cliente cliente=new Cliente();//Filtro
    private List<Cliente> clientes = new ArrayList<Cliente>(); //tabela
    ...
    private void preencherFiltro(){
        cliente.setNome(campoDescricao.getText());
    }
    ...
    private void pesquisarBD(){
        ...
        try{
            clientes=dao.pesquisar(cliente);
        }catch(BDException e){
    ...
    private void preencherTabela(){
        tabela.setModel(new ClienteTabelaModelo(clientes));
    }
    
    
    public void selecionarCliente(){
        this.clienteSelecionado = clientes.get(tabela.getSelectedRow());  
    }
    
    public void abrirTelaConsulta(){
        new ClienteConsultaTela(clienteSelecionado).setVisible(true);
    }
    /**
